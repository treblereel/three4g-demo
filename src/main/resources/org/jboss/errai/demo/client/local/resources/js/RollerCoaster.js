...
function RollerCoasterGeometry( curve, divisions ) {
    ...
    if (typeof curve.getPointAt === "function") {
        ...
        console.log('not a function 1 ');

    }

        if (typeof curve.action2 === "function") {
            console.log('action2 function 1 ');
        } else{
            console.log('action2 not a function 1 ');

        }


        console.log(JSON.stringify(curve));
        console.log(curve.getPointAt(6));
