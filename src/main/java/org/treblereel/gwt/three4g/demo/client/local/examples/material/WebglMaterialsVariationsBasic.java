...
public class WebglMaterialsVariationsBasic extends Attachable {

    public static final String name = "materials / variations / basic";
    private Font font;
    private Mesh particleLight;

    public WebglMaterialsVariationsBasic() {
    ...
    protected void doAttachInfo() {
        AppSetup.infoDiv.show().setHrefToInfo("http=//threejs.org").setTextContentToInfo("three.js").setInnetHtml(" - Basic Material Variantions by <a style='color:orange;' href=\"http://clara.io/\" target=\"_blank\" rel=\"noopener\">Ben Houston</a>.");
    }
