...
public class WebglDecals extends Attachable {
    ...
    private void shoot() {
        ...
        if (params.rotate) orientation.z = (float) (Math.random() * 2 * Math.PI);
    ...
    private void loadLeePerrySmith() {
        ...
        loader.load("models/json/leeperrysmith/LeePerrySmith.json", (OnLoadCallback<Geometry>) geometry -> {
            ...
            parameters.specularMap = textureLoader.load("models/json/leeperrysmith/Map-SPEC.jpg");
            parameters.normalMap = textureLoader.load("models/json/leeperrysmith/Infinite-Level_02_Tangent_SmoothUV.jpg");
