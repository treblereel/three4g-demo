...
public class WebglMaterialsCubemapDynamic2 extends Attachable {
    ...
    public static final String name = "materials / cubemap / dynamic2";
    ...
    private void init(Texture texture) {
        ...
        Mesh mesh = new Mesh(new SphereBufferGeometry(500, 32, 16), new MeshBasicMaterial(meshBasicMaterialParameters));
