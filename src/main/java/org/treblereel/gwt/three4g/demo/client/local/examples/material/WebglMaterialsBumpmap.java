...
public class WebglMaterialsBumpmap extends Attachable {
    ...
    public WebglMaterialsBumpmap() {
        ...
        //
        Texture mapHeight = new TextureLoader().load("models/json/leeperrysmith/Infinite-Level_02_Disp_NoSmoothUV-4096.jpg");
    ...
    private void createScene(Geometry geometry, int scale, MeshPhongMaterial material) {
    ...
    protected void doAttachInfo() {
        AppSetup.infoDiv.show().setHrefToInfo("http://threejs.org").setTextContentToInfo("three.js").setInnetHtml(" - webgl bump mapping without tangents -\n" +
