...
public class WebglMaterialsVariationsPhong extends Attachable {
    ...
    public WebglMaterialsVariationsPhong() {
    ...
    protected void doAttachInfo() {
        AppSetup.infoDiv.show().setHrefToInfo("http=//threejs.org").setTextContentToInfo("three.js").setInnetHtml(" - Phong Material Variantions by <a style='color:orange;' href=\"http://clara.io/\" target=\"_blank\" rel=\"noopener\">Ben Houston</a>.");
    }
