...
public class WebglGeometryTerrainFog extends Attachable {
    ...
    protected void doAttachInfo() {
        AppSetup.infoDiv.show().setHrefToInfo("http://threejs.org").setTextContentToInfo("three.js").setInnetHtml(" - webgl terrain + fog demo<br />(left click: forward, right click: backward)");
    }
