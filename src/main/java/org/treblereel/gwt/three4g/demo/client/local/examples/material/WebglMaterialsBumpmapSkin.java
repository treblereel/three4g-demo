...
public class WebglMaterialsBumpmapSkin extends Attachable {
    ...
    public WebglMaterialsBumpmapSkin() {
        ...
        loader.load("models/json/leeperrysmith/LeePerrySmith.json", (OnLoadCallback<Geometry>) geometry -> {
        ...
        composerBeckmann = new EffectComposer(renderer, new WebGLRenderTarget(rtwidth, rtheight, parameters));
    ...
    private void createScene(Geometry geometry, int scale) {

        TextureLoader textureLoader = new TextureLoader();
        Texture mapHeight = textureLoader.load("models/json/leeperrysmith/Infinite-Level_02_Disp_NoSmoothUV-4096.jpg");
    ...
    protected void doAttachInfo() {
        AppSetup.infoDiv.show().setHrefToInfo("http://threejs.org").setTextContentToInfo("three.js").setInnetHtml("  - webgl simple, single-pass, skin material with tangent-less bump mapping</a> -\n" +
