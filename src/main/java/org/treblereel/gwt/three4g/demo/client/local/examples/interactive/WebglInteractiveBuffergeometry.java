...
public class WebglInteractiveBuffergeometry extends Attachable {
    ...
    private void  render() {
        ...
        if ( intersects.length > 0 ) {
            ...
            BufferAttribute linePosition = ((BufferGeometry)line.geometry).attributes.get("position");
            BufferAttribute meshPosition = ((BufferGeometry)mesh.geometry).attributes.get("position");
