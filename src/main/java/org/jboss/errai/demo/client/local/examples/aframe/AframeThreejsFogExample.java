...
@LoadAsync
@ApplicationScoped
public class AframeThreejsFogExample extends Attachable {
  ...
  protected void doAttachScene() {
    ...
    Scene threejsScene = scene.getObject3D();
    threejsScene.fog = new Fog(0x1106e0, 1, 4);
  ...
  protected void doAttachInfo() {
    info.show().setHrefToInfo("https://aframe.io").setTextContentToInfo("three.js")
        .setInnetHtml("Aframe + ThreeJs example");
  }
}
