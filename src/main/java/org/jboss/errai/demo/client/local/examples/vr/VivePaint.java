...
import org.jboss.errai.demo.client.api.PaintViveController;
...
public class VivePaint extends Attachable {
    ...
    public VivePaint() {
        ...
        controller1.userData.set("points", vectors);

        Matrix4[] matrices = new Matrix4[2];
        matrices[0] = new Matrix4();
        matrices[1] = new Matrix4();

        controller1.userData.set("matrices", matrices);
        ...
        controller2.userData.set("points", vectors);

        matrices = new Matrix4[2];
        matrices[0] = new Matrix4();
        matrices[1] = new Matrix4();

        controller2.userData.set("matrices", matrices);
    ...
    public void initGeometry() {
        ...
        BufferAttribute positions = new BufferAttribute(new Float32Array(1000000 * 3), 3);
        positions.dynamic = true;
        geometry.addAttribute("position", positions);
        BufferAttribute normals = new BufferAttribute(new Float32Array(1000000 * 3), 3);
        normals.dynamic = true;
        geometry.addAttribute("normal", normals);
        BufferAttribute colors = new BufferAttribute(new Float32Array(1000000 * 3), 3);
        colors.dynamic = true;
    ...
    public void handleController(PaintViveController controller) {
        ...
        if (pivot != null) {
            ...
            Vector3 point1 = ((Vector3[]) controller.userData.get("points"))[0];
            Vector3 point2 = ((Vector3[]) controller.userData.get("points"))[1];
            Matrix4 matrix1 = ((Matrix4[]) controller.userData.get("matrices"))[0];
            Matrix4 matrix2 = ((Matrix4[]) controller.userData.get("matrices"))[1];
